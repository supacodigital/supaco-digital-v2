...
// Image OG générée dynamiquement — identité Supaco (dégradé signature)
export const alt = `${site.name} — studio web & IA du bassin franco-suisse`;
    ...
    (
      <div
        style={{
          ...
          padding: "80px",
          background:
            "radial-gradient(1000px 600px at 10% -20%, rgba(53,167,240,0.30), transparent 60%), radial-gradient(900px 600px at 110% 10%, rgba(37,99,235,0.28), transparent 55%), linear-gradient(180deg, #080b14 0%, #05070d 100%)",
          color: "#f4f7ff",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
          <svg width="76" height="76" viewBox="0 0 1200 1200">
            <defs>
              <linearGradient id="g" x1="0" y1="0" x2="1200" y2="1200" gradientUnits="userSpaceOnUse">
          ...
          <span style={{ fontSize: "34px", fontWeight: 600, letterSpacing: "-0.01em" }}>
            Supaco digital
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            Des sites web et outils IA qui font travailler votre entreprise
          </div>
          <div style={{ fontSize: "28px", color: "#aeb9d4" }}>
            Studio web &amp; IA · Pays de Gex · Bassin franco-suisse
          </div>
        </div>
      </div>
    ),
